function showAboutMe (event) {
  ...
  aboutMe.addEventListener("click", closeMeTab);}
  ...
  function showCurrentRole (event) {
    ...
    currentRole.addEventListener("click", closeRoleTab);
  }
  ...
  function showSkills (event) {
    ...
    skills.addEventListener("click", closeSkillsTab);
  }

  function closeSkillsTab(event) {
    event.preventDefault();
    skills.innerHTML = "Skills";
  }

  
  function closeRoleTab(event) {
    event.preventDefault();
    currentRole.innerHTML = "Current Role";
  }

  
  function closeMeTab(event) {
    event.preventDefault();
